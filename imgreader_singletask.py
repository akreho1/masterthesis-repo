...
class IMG_reader():
    def __init__(self, train_path, test_path, img_size, augmentacije, batch_size=1, *args, **kwargs):
        self.train_path = train_path
        self.test_path = test_path
        self.img_size = img_size
        self.batch_size = batch_size
        self.augmentations=augmentacije
        ...
        shit, self.test1 = train_test_split(train_image_names, train_size=0.8, test_size=0.2)
        self.train, self.val = train_test_split(shit, train_size=0.8, test_size=0.2)
